...
class BalloonStrategy(object):
    ...
    def move_to_target_cam_forward(self,target_info,attitude,location):
        ...
        # percabangan ini seharusnya menentukan dekat nya target.
        # disini kita set 2, artinya jarak antara target setidak 3 meter
    ...
    def pixel_point_to_position_xy(self,pixel_position,distance):
        # fungsi ini bertugas sebagai memusatkan gambar
